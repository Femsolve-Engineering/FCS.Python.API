...
class GEOMAlgo_State(enum.Enum):
	GEOMAlgo_ST_UNKNOWN : GEOMAlgo_ST_UNKNOWN = ...
	GEOMAlgo_ST_IN : GEOMAlgo_ST_IN = ...
	GEOMAlgo_ST_OUT : GEOMAlgo_ST_OUT = ...
	GEOMAlgo_ST_ON : GEOMAlgo_ST_ON = ...
	GEOMAlgo_ST_ONIN : GEOMAlgo_ST_ONIN = ...
	GEOMAlgo_ST_ONOUT : GEOMAlgo_ST_ONOUT = ...
	GEOMAlgo_ST_INOUT : GEOMAlgo_ST_INOUT = ...
...
class DocumentBuilder:
	...
	def is_item_nested(self, object_id: int) -> bool: ...
	def get_item_nesting_level(self, object_id: int) -> int: ...
	def get_nested_component_ids(self, object_id: int) -> list: ...
	def get_all_nested_component_ids(self, object_id: int) -> list: ...
	def remove_from_document(self, object_id: int) -> bool: ...
	def get_object_name(self, object_id: int) -> str: ...
	def get_geom_object_by_id(self, object_id: int) -> GEOM_Object: ...
	def open_new_document(self, model_name: str) -> None: ...
	def get_added_component_ids(self) -> list[int]: ...
	def set_object_colour(self, object_id: int, colour: Colour) -> bool: ...
	def get_object_colour(self, object_id: int) -> Colour: ...
	def set_object_visibility(self, object_id: int, is_visible: bool) -> bool: ...
	def is_object_visible(self, object_id: int) -> bool: ...
	def get_object_opacity(self, object_id: int) -> float: ...
	def set_object_opacity(self, object_id: int, opacity: float) -> bool: ...
...
class ExtGeometryShapeOperations:
	...
	def get_hidden_and_visible_edges(self, main_shape: GEOM_Object, camera_position: list, camera_direction: list, should_include_hidden: bool) -> list: ...
